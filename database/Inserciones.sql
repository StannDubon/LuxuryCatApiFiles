-- Inserciones en tb_administradores
INSERT INTO tb_administradores (admin_nombre, admin_apellido, admin_usuario, admin_contraseña, admin_correo, admin_estado, tipo_admin_id)
VALUES 
('Carlos', 'Gomez', 'cgomez', 'password1', 'carlos.gomez@example.com', 'activo', 1),
('Maria', 'Lopez', 'mlopez', 'password2', 'maria.lopez@example.com', 'activo', 2),
('Juan', 'Martinez', 'jmartinez', 'password3', 'juan.martinez@example.com', 'activo', 3),
('Ana', 'Garcia', 'agarcia', 'password4', 'ana.garcia@example.com', 'activo', 4),
('Luis', 'Hernandez', 'lhernandez', 'password5', 'luis.hernandez@example.com', 'activo', 1),
('Elena', 'Rodriguez', 'erodriguez', 'password6', 'elena.rodriguez@example.com', 'activo', 2),
('Pedro', 'Perez', 'pperez', 'password7', 'pedro.perez@example.com', 'activo', 3),
('Lucia', 'Sanchez', 'lsanchez', 'password8', 'lucia.sanchez@example.com', 'activo', 4),
('Miguel', 'Ramirez', 'mramirez', 'password9', 'miguel.ramirez@example.com', 'activo', 1),
('Raul', 'Torres', 'rtorres', 'password10', 'raul.torres@example.com', 'activo', 2),
('Andrea', 'Diaz', 'adiaz', 'password11', 'andrea.diaz@example.com', 'activo', 3),
('Sara', 'Flores', 'sflores', 'password12', 'sara.flores@example.com', 'activo', 4),
('David', 'Castro', 'dcastro', 'password13', 'david.castro@example.com', 'activo', 1),
('Laura', 'Rivas', 'lrivas', 'password14', 'laura.rivas@example.com', 'activo', 2),
('Oscar', 'Ortiz', 'oortiz', 'password15', 'oscar.ortiz@example.com', 'activo', 3),
('Pablo', 'Morales', 'pmorales', 'password16', 'pablo.morales@example.com', 'activo', 4),
('Sofia', 'Romero', 'sromero', 'password17', 'sofia.romero@example.com', 'activo', 1),
('Manuel', 'Jimenez', 'mjimenez', 'password18', 'manuel.jimenez@example.com', 'activo', 2),
('Isabel', 'Mendoza', 'imendoza', 'password19', 'isabel.mendoza@example.com', 'activo', 3),
('Alberto', 'Gutierrez', 'agutierrez', 'password20', 'alberto.gutierrez@example.com', 'activo', 4),
('Teresa', 'Soto', 'tsoto', 'password21', 'teresa.soto@example.com', 'activo', 1),
('Hector', 'Silva', 'hsilva', 'password22', 'hector.silva@example.com', 'activo', 2),
('Irene', 'Cruz', 'icruz', 'password23', 'irene.cruz@example.com', 'activo', 3),
('Fernando', 'Vargas', 'fvargas', 'password24', 'fernando.vargas@example.com', 'activo', 4),
('Carmen', 'Reyes', 'creyes', 'password25', 'carmen.reyes@example.com', 'activo', 1);
